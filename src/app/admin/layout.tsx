  ...
  return (
    <div className="min-h-screen bg-bg flex">
      ...
      <main className="flex-1 min-h-screen">
        ...
        <div className="md:hidden sticky top-0 z-20 bg-card/95 backdrop-blur-lg border-b border-border flex items-center h-14 px-4">
          <button
          ...
          <h1 className="flex-1 text-center text-sm font-semibold text-foreground truncate px-2">
            {currentPage ? t(currentPage.key) : "Admin"}
          </h1>
          <div className="w-10" />
        </div>
      ...
      {menuOpen && (
        <>
          ...
          />
          {/* Drawer */}
          <aside className="md:hidden fixed left-0 top-0 bottom-0 w-72 bg-card border-r border-border z-50 flex flex-col animate-slide-in-left">
